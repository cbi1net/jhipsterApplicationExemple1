...
import net.atos.lroux.jhipster.exemple1.config.Constants;
...
import net.atos.lroux.jhipster.exemple1.domain.PersistentToken;
import net.atos.lroux.jhipster.exemple1.domain.User;
import net.atos.lroux.jhipster.exemple1.repository.AuthorityRepository;
import net.atos.lroux.jhipster.exemple1.repository.PersistentTokenRepository;
import net.atos.lroux.jhipster.exemple1.repository.UserRepository;
import net.atos.lroux.jhipster.exemple1.security.AuthoritiesConstants;
import net.atos.lroux.jhipster.exemple1.service.MailService;
import net.atos.lroux.jhipster.exemple1.service.dto.UserDTO;
import net.atos.lroux.jhipster.exemple1.web.rest.errors.ExceptionTranslator;
import net.atos.lroux.jhipster.exemple1.web.rest.vm.KeyAndPasswordVM;
import net.atos.lroux.jhipster.exemple1.web.rest.vm.ManagedUserVM;
import net.atos.lroux.jhipster.exemple1.service.UserService;
...
@SpringBootTest(classes = JhipsterApplicationExemple1App.class)
